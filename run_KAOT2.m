function results = run_KAOT2(seq, res_path, bSaveImage)
%%
setup_paths();

%n = size(seq.s_frames);
%for i = 1:n(2)
%    tmp_str = {strrep(char(seq.s_frames{i}), 'D:\Tracking\UAV123_10fps\data_seq\\', 'C:\Users\pc\Desktop\Lectures\과기사관\MitiTech\Dataset_UAV123_10fps\UAV123_10fps\data_seq\UAV123_10fps\')};
%    seq.s_frames{i} = tmp_str{1};
%end
...
params.gpu_id = [0];                     % Set the GPU id, or leave empty to use default
